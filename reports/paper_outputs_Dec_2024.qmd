...
#set Other as a base for ministry_by_party
data_for_analysis_senior$ministry_by_party <- relevel(data_for_analysis_senior$ministry_by_party, ref = "Other")
#set Very Senior as a based for ranking
data_for_analysis_senior$ranking <- relevel(data_for_analysis_senior$ranking, ref = "very senior")
...
politicization_mod1 <- lm(PROJECT_POLITICIZATION ~ 
                            BACKSLIDING_2 +   PAST_POLITICIZATION + PAST_INFLUENCE,
                          data=data_for_analysis_senior)
politicization_mod1_controls <- politicization_mod1 %>% update(.~.+religiosity + education+ gender +tenure+ position_type+ ranking+ age+ jurist+ ministry_by_party)


sjPlot::tab_model(
                  politicization_mod1,politicization_mod1_controls,
                  show.ci = F,
                  show.se = T,
                  show.std = T,
                  collapse.se = T,
...
influence_mod1 <- politicization_mod1 %>%  update(PROJECT_INFLUENCE~.)
influence_mod1_controls <- influence_mod1 %>% update(.~.+religiosity + education+ gender +tenure+ position_type+ ranking+ age+ jurist+ ministry_by_party)

sjPlot::tab_model(
                  influence_mod1,influence_mod1_controls,
                  show.ci = F,
                  show.se = T,
                  show.std = T,
                  collapse.se = T,
...
exit_mod2 <- exit_mod1 %>%  update(.~. + PROJECT_POLITICIZATION + PROJECT_INFLUENCE)
exit_mod3 <- exit_mod2 %>%  update(.~. +religiosity + education+ gender +tenure+ position_type+ ranking+ age+ jurist+ ministry_by_party)
...
voice_mod1 <- exit_mod1 %>% update(PROJECT_VOICE~.+ PAST_VOICE)
voice_mod2 <- voice_mod1 %>%  update(.~. + PROJECT_POLITICIZATION + PROJECT_INFLUENCE)
voice_mod3 <- voice_mod2 %>%  update(.~. +religiosity + education+ gender +tenure+ position_type+ ranking+ age+ jurist+ ministry_by_party)
...
work_mod1 <- exit_mod1 %>% update(PROJECT_EFFORT~.+ PAST_EFFORT)
work_mod2 <- work_mod1 %>%  update(.~. + PROJECT_POLITICIZATION + PROJECT_INFLUENCE)
work_mod3 <- work_mod2 %>%  update(.~. +religiosity + education+ gender +tenure+ position_type+ ranking+ age+ jurist+ ministry_by_party)
...
exit_mod1 <- lm(INTENT_EXIT_2 ~ 
                  BACKSLIDING_2 +   
                  PAST_POLITICIZATION + PAST_INFLUENCE+ PROJECT_POLITICIZATION + PROJECT_INFLUENCE +education+ gender +tenure+ position_type+ ranking+ age+ jurist + ministry_by_party,
                data=data_for_analysis_senior)
...
sjPlot::tab_model(exit_mod1,exit_mod1_ministry_by_party_interaction,exit_mod1_jurist_interaction,
                  show.ci = F,
                  show.se = T,
                  show.std = T,
                  collapse.se = T,
...
sjPlot::tab_model(voice_mod1,voice_mod1_ministry_by_party_interaction,voice_mod1_jurist_interaction,
                  show.ci = F,
                  show.se = T,
                  show.std = T,
                  collapse.se = T,
...
effort_mod1 <- lm(PROJECT_EFFORT ~ 
                   BACKSLIDING_2 +   
                   PAST_POLITICIZATION + PAST_INFLUENCE+ PROJECT_POLITICIZATION + PROJECT_INFLUENCE +education+ gender +tenure+ position_type+ ranking+ age+ jurist + ministry_by_party,
                 data=data_for_analysis_senior)
effort_mod1_ministry_by_party_interaction <- effort_mod1 %>% update(.~.+ BACKSLIDING_2:ministry_by_party )
effort_mod1_jurist_interaction <- effort_mod1 %>% update(.~.+ BACKSLIDING_2:jurist )



sjPlot::tab_model(effort_mod1,effort_mod1_ministry_by_party_interaction,effort_mod1_jurist_interaction,
                  show.ci = F,
                  show.se = T,
                  show.std = T,
                  collapse.se = T,
...
Models with Junior Civil Servants
```{r}
